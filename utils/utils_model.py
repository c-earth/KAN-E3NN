...
from utils.kan_fc import KANFullyConnectedNet
import math
import time
...
class GraphConvolution(torch.nn.Module):
    def __init__(self,
        ...
        self.edge2weight = KANFullyConnectedNet([number_of_basis] + radial_layers * [radial_neurons] + [self.tensor_edge.weight_numel], torch.nn.functional.silu)
